...
[Get Postman Collection](https://premierpos.kaytontech.com/public/docs/collection.json)
...
```bash
curl -X GET \
    -G "https://premierpos.kaytontech.com/public/connector/api/get-attendance/1" \
...
```javascript
const url = new URL(
    "https://premierpos.kaytontech.com/public/connector/api/get-attendance/1"
);
...
```bash
curl -X POST \
    "https://premierpos.kaytontech.com/public/connector/api/clock-in" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_in_time":"2000-06-13 13:13:00","clock_in_note":"praesentium","ip_address":"ut","latitude":"id","longitude":"sint"}'
...
```bash
curl -X POST \
    "https://premierpos.kaytontech.com/public/connector/api/clock-out" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_out_time":"2000-06-13 13:13:00","clock_out_note":"esse","latitude":"eum","longitude":"sint"}'
...
```bash
curl -X GET \
    -G "https://premierpos.kaytontech.com/public/connector/api/holidays?location_id=sequi&start_date=2020-06-25&end_date=2020-06-25" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://premierpos.kaytontech.com/public/connector/api/holidays"
);
...
```bash
curl -X GET \
    -G "https://premierpos.kaytontech.com/public/connector/api/brand" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://premierpos.kaytontech.com/public/connector/api/brand"
);
...
```bash
curl -X GET \
    -G "https://premierpos.kaytontech.com/public/connector/api/brand/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://premierpos.kaytontech.com/public/connector/api/brand/1"
);
...
```bash
curl -X GET \
    -G "https://premierpos.kaytontech.com/public/connector/api/business-location" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://premierpos.kaytontech.com/public/connector/api/business-location"
);
...
```bash
curl -X GET \
    -G "https://premierpos.kaytontech.com/public/connector/api/business-location/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://premierpos.kaytontech.com/public/connector/api/business-location/1"
);
...
```bash
curl -X GET \
    -G "https://premierpos.kaytontech.com/public/connector/api/crm/follow-ups?start_date=2020-12-16&end_date=2020-12-16&status=doloribus&follow_up_type=iste&order_by=start_datetime&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://premierpos.kaytontech.com/public/connector/api/crm/follow-ups"
);
...
```bash
curl -X GET \
    -G "https://premierpos.kaytontech.com/public/connector/api/crm/follow-ups/1,2" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://premierpos.kaytontech.com/public/connector/api/crm/follow-ups/1,2"
);
...
```bash
curl -X PUT \
    "https://premierpos.kaytontech.com/public/connector/api/crm/follow-ups/20" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"title":"Meeting with client","contact_id":2,"description":"officia","schedule_type":"voluptatum","user_id":"[2,3,5]","notify_before":5,"notify_type":"minute","status":"open","notify_via":"['sms' => 0 ,'mail' => 1]","followup_additional_info":"['call duration' => '1 hour']","start_datetime":"2021-01-06 13:05:00","end_datetime":"2021-01-06 13:05:00","allow_notification":true}'
...
```bash
curl -X GET \
    -G "https://premierpos.kaytontech.com/public/connector/api/crm/follow-up-resources" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://premierpos.kaytontech.com/public/connector/api/crm/follow-up-resources"
);
...
```bash
curl -X GET \
    -G "https://premierpos.kaytontech.com/public/connector/api/crm/leads?assigned_to=1%2C2%2C3&name=alias&biz_name=molestiae&mobile_num=4&contact_id=aliquam&order_by=aperiam&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://premierpos.kaytontech.com/public/connector/api/crm/leads"
);
...
```bash
curl -X POST \
    "https://premierpos.kaytontech.com/public/connector/api/crm/call-logs" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"call_logs":[{"mobile_number":"velit","mobile_name":"consequuntur","call_type":"call","start_time":"sit","end_time":"sint","duration":"est"}]}'
...
```bash
curl -X GET \
    -G "https://premierpos.kaytontech.com/public/connector/api/cash-register?status=open&user_id=10&start_date=2018-06-25&end_date=2018-06-25&location_id=animi&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://premierpos.kaytontech.com/public/connector/api/cash-register"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":18,"initial_amount":182331.5428,"created_at":"2020-5-7 15:20:22","closed_at":"2020-5-7 15:20:22","status":"close","closing_amount":635896.6,"total_card_slips":8,"total_cheques":6,"closing_note":"omnis","transaction_ids":"1,2,3"}'
...
```bash
curl -X GET \
    -G "https://premierpos.kaytontech.com/public/connector/api/cash-register/59" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://premierpos.kaytontech.com/public/connector/api/cash-register/59"
);
...
```bash
curl -X GET \
    -G "https://premierpos.kaytontech.com/public/connector/api/contactapi?type=similique&name=velit&biz_name=unde&mobile_num=14&contact_id=aliquam&order_by=nemo&direction=dolor&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://premierpos.kaytontech.com/public/connector/api/contactapi"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"reiciendis","prefix":"quis","first_name":"doloremque","middle_name":"cum","last_name":"cumque","tax_number":"8787fefef","pay_term_number":3,"pay_term_type":"months","mobile":"4578691009","landline":"5487-8454-4145","alternate_number":"841847541222","address_line_1":"praesentium","address_line_2":"non","city":"nobis","state":"maxime","country":"sit","zip_code":"non","customer_group_id":"voluptatem","contact_id":"aliquid","dob":"2000-06-13","custom_field1":"sunt","custom_field2":"facilis","custom_field3":"commodi","custom_field4":"reiciendis","email":"doloribus","shipping_address":"fugiat","position":"et","opening_balance":0,"source_id":18,"life_stage_id":16,"assigned_to":[]}'
...
let body = {
    ...
    "country": "sit",
    "zip_code": "non",
    "customer_group_id": "voluptatem",
    "contact_id": "aliquid",
    "dob": "2000-06-13",
    "custom_field1": "sunt",
    "custom_field2": "facilis",
    "custom_field3": "commodi",
    "custom_field4": "reiciendis",
    "email": "doloribus",
...
```bash
curl -X GET \
    -G "https://premierpos.kaytontech.com/public/connector/api/contactapi/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://premierpos.kaytontech.com/public/connector/api/contactapi/1"
);
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"facere","prefix":"tempore","first_name":"animi","middle_name":"impedit","last_name":"facilis","tax_number":"488744dwd","pay_term_number":3,"pay_term_type":"months","mobile":"8795461009","landline":"65484-848-848","alternate_number":"9898795220","address_line_1":"alias","address_line_2":"commodi","city":"alias","state":"rerum","country":"eius","zip_code":"officia","customer_group_id":"alias","contact_id":"laboriosam","dob":"2000-06-13","custom_field1":"aliquam","custom_field2":"excepturi","custom_field3":"autem","custom_field4":"similique","email":"eos","shipping_address":"neque","position":"voluptates","opening_balance":10.3,"source_id":4,"life_stage_id":5,"assigned_to":[]}'
...
let body = {
    ...
    "country": "eius",
    "zip_code": "officia",
    "customer_group_id": "alias",
    "contact_id": "laboriosam",
    "dob": "2000-06-13",
    "custom_field1": "aliquam",
    "custom_field2": "excepturi",
    "custom_field3": "autem",
    "custom_field4": "similique",
    "email": "eos",
    "shipping_address": "neque",
    "position": "voluptates",
...
```bash
curl -X POST \
    "https://premierpos.kaytontech.com/public/connector/api/contactapi-payment" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":17,"amount":453.13,"method":"cash","paid_on":"2020-07-22 15:48:29","account_id":14,"card_number":"ut","card_holder_name":"ullam","card_transaction_number":"aut","card_type":"quis","card_month":"nam","card_year":"consectetur","card_security":"autem","transaction_no_1":"consequatur","transaction_no_2":"ratione","transaction_no_3":"vel","cheque_number":"soluta","bank_account_number":"non","note":"assumenda"}'
...
let body = {
    ...
    "account_id": 14,
    "card_number": "ut",
    "card_holder_name": "ullam",
    "card_transaction_number": "aut",
    "card_type": "quis",
    "card_month": "nam",
    "card_year": "consectetur",
    "card_security": "autem",
    "transaction_no_1": "consequatur",
    "transaction_no_2": "ratione",
...
```bash
curl -X GET \
    -G "https://premierpos.kaytontech.com/public/connector/api/expense?location_id=ipsum&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=maiores&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://premierpos.kaytontech.com/public/connector/api/expense"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":16,"final_total":920103043.82,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":20,"expense_for":11,"contact_id":1,"additional_notes":"nulla","is_refund":0,"is_recurring":0,"recur_interval":13,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"sed","recur_repetitions":16,"payment":[{"amount":453.13,"method":"cash","account_id":15,"card_number":"repellat","card_holder_name":"delectus","card_transaction_number":"labore","card_type":"quaerat","card_month":"inventore","card_year":"nulla","card_security":"maiores","transaction_no_1":"aperiam","transaction_no_2":"recusandae","transaction_no_3":"distinctio","note":"aut","cheque_number":"ipsum"}]}'
...
let body = {
    "location_id": 16,
    "final_total": 920103043.82,
    "transaction_date": "2020-5-7 15:20:22",
    "tax_rate_id": 20,
    "expense_for": 11,
    "contact_id": 1,
    "additional_notes": "nulla",
    "is_refund": 0,
    "is_recurring": 0,
    "recur_interval": 13,
    ...
    "payment": [
        {
            ...
            "method": "cash",
            "account_id": 15,
            "card_number": "repellat",
            "card_holder_name": "delectus",
            "card_transaction_number": "labore",
            "card_type": "quaerat",
            "card_month": "inventore",
            "card_year": "nulla",
            "card_security": "maiores",
            "transaction_no_1": "aperiam",
            "transaction_no_2": "recusandae",
...
```bash
curl -X GET \
    -G "https://premierpos.kaytontech.com/public/connector/api/expense/59" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://premierpos.kaytontech.com/public/connector/api/expense/59"
);
...
```bash
curl -X PUT \
    "https://premierpos.kaytontech.com/public/connector/api/expense/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"final_total":351219.58887,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":13,"expense_for":20,"contact_id":18,"additional_notes":"sit","is_recurring":0,"recur_interval":3,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"porro","recur_repetitions":3,"payment":[]}'
...
```bash
curl -X GET \
    -G "https://premierpos.kaytontech.com/public/connector/api/expense-refund?location_id=magni&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=in&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://premierpos.kaytontech.com/public/connector/api/expense-refund"
);
...
```bash
curl -X GET \
    -G "https://premierpos.kaytontech.com/public/connector/api/product?brand_id=voluptatem&category_id=dolor&sub_category_id=consequatur&location_id=debitis&selling_price_group=nulla&name=ipsa&sku=itaque&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://premierpos.kaytontech.com/public/connector/api/product"
);
...
```bash
curl -X GET \
    -G "https://premierpos.kaytontech.com/public/connector/api/product/1?selling_price_group=magnam" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://premierpos.kaytontech.com/public/connector/api/product/1"
);

let params = {
    "selling_price_group": "magnam",
};
Object.keys(params)
    .forEach(key => url.searchParams.append(key, params[key]));
...
```bash
curl -X GET \
    -G "https://premierpos.kaytontech.com/public/connector/api/selling-price-group" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://premierpos.kaytontech.com/public/connector/api/selling-price-group"
);
...
```bash
curl -X GET \
    -G "https://premierpos.kaytontech.com/public/connector/api/variation/?brand_id=ipsa&category_id=minima&sub_category_id=expedita&not_for_selling=est&name=eos&sku=eos&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://premierpos.kaytontech.com/public/connector/api/variation/"
);

let params = {
    "brand_id": "ipsa",
    "category_id": "minima",
    "sub_category_id": "expedita",
    "not_for_selling": "est",
    "name": "eos",
    "sku": "eos",
    "per_page": "10",
...
```bash
curl -X GET \
    -G "https://premierpos.kaytontech.com/public/connector/api/sell?location_id=quidem&contact_id=iusto&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&user_id=possimus&service_staff_id=aut&shipping_status=ordered&only_subscriptions=veritatis&order_by_date=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://premierpos.kaytontech.com/public/connector/api/sell"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"sells":[{"location_id":5,"contact_id":10,"transaction_date":"2020-07-22 15:48:29","invoice_no":"ipsum","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":19,"discount_amount":10,"discount_type":"fixed","sale_note":"beatae","staff_note":"dolor","commission_agent":19,"shipping_details":"Express Delivery","shipping_address":"modi","shipping_status":"ordered","delivered_to":"'Mr robin'","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":14,"pay_term_number":3,"pay_term_type":"months","is_suspend":false,"is_recurring":0,"recur_interval":1,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"beatae","recur_repetitions":18,"rp_redeemed":7,"rp_redeemed_amount":13.5,"types_of_service_id":7,"service_custom_field_1":"est","service_custom_field_2":"qui","service_custom_field_3":"iure","service_custom_field_4":"tempore","round_off_amount":35980842.04213,"table_id":1,"service_staff_id":5,"change_return":0,"products":[{"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":0,"discount_amount":0,"discount_type":"percentage","sub_unit_id":6,"note":"quo"}],"payments":[{"amount":453.13,"method":"cash","account_id":5,"card_number":"dolores","card_holder_name":"sit","card_transaction_number":"enim","card_type":"eveniet","card_month":"commodi","card_year":"officia","card_security":"deleniti","transaction_no_1":"perspiciatis","transaction_no_2":"aut","transaction_no_3":"blanditiis","bank_account_number":"aut","note":"saepe","cheque_number":"aut"}]}]}'
    ...
    "sells": [
        {
            ...
            "service_custom_field_3": "iure",
            "service_custom_field_4": "tempore",
            "round_off_amount": 35980842.04213,
            "table_id": 1,
            "service_staff_id": 5,
            "change_return": 0,
            "products": [
            ...
            "payments": [
                {
                    ...
                    "account_id": 5,
                    "card_number": "dolores",
                    "card_holder_name": "sit",
                    "card_transaction_number": "enim",
                    "card_type": "eveniet",
                    "card_month": "commodi",
                    "card_year": "officia",
                    "card_security": "deleniti",
                    "transaction_no_1": "perspiciatis",
...
```bash
curl -X GET \
    -G "https://premierpos.kaytontech.com/public/connector/api/sell/55" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://premierpos.kaytontech.com/public/connector/api/sell/55"
);
...
```bash
curl -X PUT \
    "https://premierpos.kaytontech.com/public/connector/api/sell/6" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":3,"transaction_date":"2020-5-7 15:20:22","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":13,"discount_amount":10,"discount_type":"fixed","sale_note":"id","staff_note":"voluptas","sells":[{"is_suspend":false}],"commission_agent":10,"shipping_details":"Express Delivery","shipping_address":"non","shipping_status":"ordered","delivered_to":"Mr Robin","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":13,"pay_term_number":8,"pay_term_type":"months","is_recurring":0,"recur_interval":17,"recur_interval_type":"days","subscription_repeat_on":7,"subscription_no":"eaque","recur_repetitions":3,"rp_redeemed":15,"rp_redeemed_amount":13.5,"types_of_service_id":13,"service_custom_field_1":"distinctio","service_custom_field_2":"adipisci","service_custom_field_3":"ut","service_custom_field_4":"ullam","round_off_amount":22479.54,"table_id":14,"service_staff_id":10,"change_return":0,"change_return_id":13,"products":[{"sell_line_id":15,"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":13,"discount_amount":0,"discount_type":"percentage","sub_unit_id":6,"note":"ipsa"}],"payments":[{"payment_id":7,"amount":453.13,"method":"cash","account_id":9,"card_number":"perferendis","card_holder_name":"ea","card_transaction_number":"non","card_type":"in","card_month":"velit","card_year":"repellendus","card_security":"in","transaction_no_1":"hic","transaction_no_2":"dolores","transaction_no_3":"et","note":"et","cheque_number":"reprehenderit","bank_account_number":"sit"}]}'
...
let body = {
    ...
    "subscription_no": "eaque",
    "recur_repetitions": 3,
    "rp_redeemed": 15,
    "rp_redeemed_amount": 13.5,
    "types_of_service_id": 13,
    "service_custom_field_1": "distinctio",
    "service_custom_field_2": "adipisci",
    "service_custom_field_3": "ut",
    "service_custom_field_4": "ullam",
    "round_off_amount": 22479.54,
    "table_id": 14,
    "service_staff_id": 10,
    "change_return": 0,
    "change_return_id": 13,
...
```bash
curl -X DELETE \
    "https://premierpos.kaytontech.com/public/connector/api/sell/laboriosam" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X POST \
    "https://premierpos.kaytontech.com/public/connector/api/sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"transaction_id":19,"transaction_date":"2020-5-7 15:20:22","invoice_no":"exercitationem","discount_amount":10,"discount_type":"fixed","products":[{"sell_line_id":20,"quantity":1,"unit_price_inc_tax":437.5}]}'
...
```bash
curl -X GET \
    -G "https://premierpos.kaytontech.com/public/connector/api/list-sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://premierpos.kaytontech.com/public/connector/api/list-sell-return"
);
...
```bash
curl -X POST \
    "https://premierpos.kaytontech.com/public/connector/api/update-shipping-status" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"id":6,"shipping_status":"ordered","delivered_to":"quia"}'
...
```bash
curl -X GET \
    -G "https://premierpos.kaytontech.com/public/connector/api/active-subscription" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://premierpos.kaytontech.com/public/connector/api/active-subscription"
);
...
```bash
curl -X GET \
    -G "https://premierpos.kaytontech.com/public/connector/api/packages" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://premierpos.kaytontech.com/public/connector/api/packages"
);
...
```bash
curl -X GET \
    -G "https://premierpos.kaytontech.com/public/connector/api/table?location_id=et" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://premierpos.kaytontech.com/public/connector/api/table"
);
...
```bash
curl -X GET \
    -G "https://premierpos.kaytontech.com/public/connector/api/table/5" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://premierpos.kaytontech.com/public/connector/api/table/5"
);
...
```bash
curl -X GET \
    -G "https://premierpos.kaytontech.com/public/connector/api/tax" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://premierpos.kaytontech.com/public/connector/api/tax"
);
...
```bash
curl -X GET \
    -G "https://premierpos.kaytontech.com/public/connector/api/tax/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://premierpos.kaytontech.com/public/connector/api/tax/1"
);
...
```bash
curl -X GET \
    -G "https://premierpos.kaytontech.com/public/connector/api/taxonomy?type=quibusdam" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://premierpos.kaytontech.com/public/connector/api/taxonomy"
);
...
```bash
curl -X GET \
    -G "https://premierpos.kaytontech.com/public/connector/api/taxonomy/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://premierpos.kaytontech.com/public/connector/api/taxonomy/1"
);
...
```bash
curl -X GET \
    -G "https://premierpos.kaytontech.com/public/connector/api/types-of-service" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://premierpos.kaytontech.com/public/connector/api/types-of-service"
);
...
```bash
curl -X GET \
    -G "https://premierpos.kaytontech.com/public/connector/api/types-of-service/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://premierpos.kaytontech.com/public/connector/api/types-of-service/1"
);
...
```bash
curl -X GET \
    -G "https://premierpos.kaytontech.com/public/connector/api/unit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://premierpos.kaytontech.com/public/connector/api/unit"
);
...
```bash
curl -X GET \
    -G "https://premierpos.kaytontech.com/public/connector/api/unit/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://premierpos.kaytontech.com/public/connector/api/unit/1"
);
...
```bash
curl -X GET \
    -G "https://premierpos.kaytontech.com/public/connector/api/user/loggedin" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://premierpos.kaytontech.com/public/connector/api/user/loggedin"
);
...
```bash
curl -X GET \
    -G "https://premierpos.kaytontech.com/public/connector/api/user?service_staff=qui" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://premierpos.kaytontech.com/public/connector/api/user"
);
...
```bash
curl -X GET \
    -G "https://premierpos.kaytontech.com/public/connector/api/user/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://premierpos.kaytontech.com/public/connector/api/user/1"
);
...
```bash
curl -X POST \
    "https://premierpos.kaytontech.com/public/connector/api/update-password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"current_password":"odit","new_password":"odit"}'
...
```bash
curl -X GET \
    -G "https://premierpos.kaytontech.com/public/connector/api/payment-accounts" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://premierpos.kaytontech.com/public/connector/api/payment-accounts"
);
...
```bash
curl -X GET \
    -G "https://premierpos.kaytontech.com/public/connector/api/payment-methods" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://premierpos.kaytontech.com/public/connector/api/payment-methods"
);
...
```bash
curl -X GET \
    -G "https://premierpos.kaytontech.com/public/connector/api/business-details" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://premierpos.kaytontech.com/public/connector/api/business-details"
);
...
```bash
curl -X GET \
    -G "https://premierpos.kaytontech.com/public/connector/api/profit-loss-report?location_id=sequi&start_date=2018-06-25&end_date=2018-06-25&user_id=distinctio" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://premierpos.kaytontech.com/public/connector/api/profit-loss-report"
);
...
```bash
curl -X GET \
    -G "https://premierpos.kaytontech.com/public/connector/api/product-stock-report" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://premierpos.kaytontech.com/public/connector/api/product-stock-report"
);
...
```bash
curl -X GET \
    -G "https://premierpos.kaytontech.com/public/connector/api/notifications" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://premierpos.kaytontech.com/public/connector/api/notifications"
);
